      ...
      <div className="character-header">
        ...
        <Space>
          ...
          <Button icon={<ThunderboltOutlined />} onClick={async () => {
            try {
              // 测试 v2 角色卡
              await window.electronAPI.character.testRead('g:\\AI\\travenManager\\main_homeless-dog-ponporio-990658749ba1_spec_v2.png');
              // 测试 v3 角色卡
              await window.electronAPI.character.testRead('g:\\AI\\travenManager\\main_lomadi-your-assigned-kitsunegirl-2bfcdfa3a2e9_spec_v2.png');
